            ...
            <div className='mx-auto w-full md:w-3/4 lg:w-1/2 p-16'>
                ...
                <form onSubmit={handleSubmit} className="border-4 border-green-600 p-10 rounded-xl">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                        <button
                            type="submit"
                            className="rounded-md bg-green-600 w-full px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
                        >
                            Login
                        </button>
                    </div>
                </form>
                <p className="text-center mt-2 text-gray-600">Doesn&apos;t have an account ? <a href="/user/register" className="text-green-600 font-semibold underline">Register</a></p>
            </div>
        </Layout>
    )
}
